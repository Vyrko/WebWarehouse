...
function onConnected() {
    ...
    stompClient.send("/app/user.connectedUser",
        {},
        JSON.stringify({email: nickname, name: fullname, status: 'ONLINE'})
    );
...
function appendUserElement(user, connectedUsersList) {
    ...
    userImage.src = '../img/Chat/user_icon.png';
...
function onLogout() {
    stompClient.send("/app/user.disconnectUser",
        {},
        JSON.stringify({email: nickname, name: fullname, status: 'OFFLINE'})
    );
